        ...
        <div className='todoapp'>
          ...
          <section className='main'>
            <ul className='todo-list'>
              {this.state.todos.map(todo => <TodoItem text={todo.title} key={todo.id} handleCheck={this.handleCheckClick(todo.id)} handleDestroyOnButtonClick={this.handleDestroyOnButtonClick(todo.id)} completed={todo.completed} />)}
            </ul>
          </section>
